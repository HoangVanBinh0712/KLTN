          ...
          <div className="paging-post" style={{ marginTop: "15px" }}>
            ...
            {allPost.map((p, id) => (
              <div
                ...
                key={id}
                style={
                  currentPage === id ? { backgroundColor: "#0c62ad", border: "2px solid #0c62ad" } : { backgroundColor: "#cfcfcf", border: "2px solid #cfcfcf" }
                }
              ></div>
            ))}
        ...
        <div className="body-container">
          ...
          <div className="profile-head">
            ...
            {isAuthenticated && role === "ROLE_USER" ? (
              <>
                {isFollow ? (
                  <div className="follow-company" style={{ backgroundColor: "gray" }}  onClick={() => onClicUnfollow(id)}>
                    Unfollow company
                  </div>
                ) : (
