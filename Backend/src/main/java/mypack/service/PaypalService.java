...
public class PaypalService {
    ...
    public Payment createPayment(Long orderId, String cancelUrl, String successUrl) throws PayPalRESTException {
        ...
        String intent = "sale";
        String description = String.format("Rent service %s in %d months (%d).",
                service.getName(), order.getDuration(), order.getId());
    ...
    public Boolean handleSuccess(Payment payment) throws PayPalRESTException {
        ...
        try {
            ...
            if (sv == null) {
                ...
                order.setNote("Update service form " + oldDate.toString() + " to "
                        + newDate.toString() + " .");
